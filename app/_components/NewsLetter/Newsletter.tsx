...
const Newsletter = () => {
  return (
    <section className="overflow-hidden mb-10 mt-5">
      <div className="container mx-auto px-4 sm:px-8 xl:px-0">
        <div className="relative z-1 overflow-hidden rounded-xl">
          ...
          <div className="relative z-2 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 px-4 sm:px-7.5 xl:pl-12.5 xl:pr-14 py-11">
              ...
              <form>
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    className="w-full bg-gray-100 border border-gray-300 outline-none rounded-md placeholder:text-dark-4 py-3 px-5"
                  />
                  <button
                    type="submit"
                    className="inline-flex justify-center py-3 px-7 text-white bg-orange-400 font-medium rounded-md ease-out duration-200 hover:bg-blue-dark"
                  >
                    Subscribe
                  </button>
                </div>
