...
const RecentVisitProduct = () => {
  ...
  const getRecentProducts = async (): Promise<Product[]> => {
    ...
    const res = await fetch("/api/productRecentVisit", {
      method: "POST",
  ...
  return (
    ...
    //   <h3 className="font-bold mb-2">Recently Visited Products</h3>
...
export default RecentVisitProduct;
