...
export default function FormElementsPage() {
  ...
  useEffect(() => {
    async function loadProducts() {
      try {
        const res = await axios.get("/api/protected/faqs");
            ...
            {products?.map((items:Faq, index) => {
              return (
                ...
                >
                  ...
                  <td
                    // scope="row"
                     className=" py-2 items-center  text-blue-900 dark:text-white"
                  >
                  ...
                  <td className="px-6">{items?.answer}</td>
                  <td className="px-6">
                    <div className="flex items-center">
